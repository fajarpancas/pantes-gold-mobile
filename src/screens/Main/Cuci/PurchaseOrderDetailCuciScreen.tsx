...
class PurchaseOrderDetailCuciScreen extends React.PureComponent {
  constructor(props) {
    super(props);
  ...
  onRefresh = () => {
    ...
    getPurchaseOrderDetail(
      {id_order: params?.id_order, kd_toko: 0},
      (response: any) => {
...
export default connect(stores)(PurchaseOrderDetailCuciScreen);
